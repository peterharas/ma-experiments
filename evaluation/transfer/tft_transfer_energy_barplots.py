...
df_tft_individual = pd.read_csv(
    'results/TFT_WEATHER_results_20260710_122632.csv'
)

df_tft_large = pd.read_csv(
    'results/TFT_LARGE_WEATHER_results_20260716_184756.csv'
)

df_tft_transfer = pd.read_csv(
    'results/TFT_TRANSFER_results_20260717_205404.csv'
)
...
df_tft_individual = df_tft_individual[
    df_tft_individual['spring_id'].isin(transfer_springs)
]

df_tft_large = df_tft_large[
    df_tft_large['spring_id'].isin(transfer_springs)
]

df_tft_transfer = df_tft_transfer[
    df_tft_transfer['spring_id'].isin(transfer_springs)
]


# Only use horizon 1
df_tft_individual = df_tft_individual[
    df_tft_individual['horizon'] == 1
]

df_tft_large = df_tft_large[
    df_tft_large['horizon'] == 1
]

df_tft_transfer = df_tft_transfer[
    df_tft_transfer['horizon'] == 1
]
