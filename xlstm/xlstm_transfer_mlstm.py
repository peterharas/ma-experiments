...
for spring_id in spring_ids:
    ...
    # 4. Freeze specific layers (input projection & backbone, except mLSTM blocks)
    ...
    for name, module in model.backbone.named_modules():
        if "mLSTMBlock" in module.__class__.__name__:
    ...
    for i, d in enumerate(FORECAST_DAYS):
        ...
        results.append({
            ...
            "architecture": LM_ARCHITECTURE,
            "frozen_layers": "input_proj, backbone (except mLSTM)"
        })
